Feature: Test plugin renderer
  ...
  Scenario: The renderer should be present
    Then I expect "#view-port>#root" is visible
  ...
  Scenario: Components should be properly nested
    Then I expect "#server1" to have "#network1 .components" as parent
    And I expect "#server2" to have "#network1 .components" as parent
