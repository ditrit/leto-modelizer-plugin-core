...
describe('Test Class: ElkLayout', () => {
  ...
  describe('Test method: getNodes', () => {
    const layoutManager = new ElkLayout(undefined);

    it('should throw exception on undefined argument', () => {
      expect(() => layoutManager.getNodes(undefined)).toThrow();
    });
    ...
    it('captures parent-child relationship and depth in the expected way', () => {
      const comp1 = new Component({
        id: 'my_id_1',
        name: 'my_name_1',
      });
    ...
    // TODO : error on missing parent / link ? (do we want an error ?)
  });
  ...
  describe('Test method: getParentsByDepth', () => {
    ...
    it('returns no parents when no components are provided', () => {
      expect(layoutManager.getParentsByDepth(new Map())).toEqual([]);
    });

    it('has expected behavior with 3 given components', () => {
      const comp1 = new Component({
        id: 'my_id_1',
        name: 'my_name_1',
      });
      ...
      const nodes = layoutManager.getNodes([comp2, comp1, comp3]);
  ...
  describe('Test method: generateLayout', () => {
    ...
    it('calls the expected underlying function', () => {
  ...
  describe('Test method: generateELKLayout', () => {
    ...
    it('provides to ELK the right input format on a minimal example', () => {
      const node = {
        raw: undefined,
        children: [{
          raw: {
    ...
    it('provides to ELK the right input format on a full example', () => {
  ...
  describe('Test method: getAncestorByDepth', () => {
    ...
    it('climbs the tree structure correctly', () => {
      const a = {
        parent: {
          parent: {
            parent: {},
  ...
  describe('Test method: getLinksForChildren', () => {
    ...
    it('finds the links among children of given parent node', () => {
      const nodes = layoutManager.getNodes(exampleComponents);
  ...
  describe('Test method: writeLayout', () => {
    it('calls writeSingleDepthLayout with correct arguments', () => {
  ...
  describe('Test method: writeSingleDepthLayout', () => {
    ...
    it('writes the provided layout to the components model', () => {
      const pluginData = {
  ...
  describe('Test method: arrangeComponentsPosition', () => {
    it('calls the appropriate underlying methods', async () => {
      // no need for real data here as it is not used
