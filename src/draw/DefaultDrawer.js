...
class DefaultDrawer {
  ...
  * @param {Object} components HTML elements selected by D3.js
  */
  drawDefaultResource(component) {
    ...
    component.select('.component-name').text((data) => data.name);
    component.select('.component-type').text((data) => data.definition.type);
  }
}
